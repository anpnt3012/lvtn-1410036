...
def train(args, config):
    ...
    trainset = CocoDataset(
        #root_dir = '/content/drive/MyDrive/v2_vehicle_counting_EfficientDet/datasets/custom_datasets/images',
        #ann_path = '/content/drive/MyDrive/v2_vehicle_counting_EfficientDet/datasets/custom_datasets/annotations/instances_train.json',
    ...
    valset = CocoDataset(
        #root_dir = '/content/drive/MyDrive/v2_vehicle_counting_EfficientDet/datasets/custom_datasets/images',
        #ann_path = '/content/drive/MyDrive/v2_vehicle_counting_EfficientDet/datasets/custom_datasets/annotations/instances_val.json',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='custom_datasets.yaml', help='project file that contains parameters')
    ...
    parser.add_argument('--resume', type=str, default='weights/efficientdet-d2.pth',
