...
if __name__ == '__main__':
    ...
    parser.add_argument('--image', type=str, default='datasets/custom_datasets/images', help='path to image')
    ...
    parser.add_argument('--weight', type=str, default='weights/custom_datasets/EfficientDet_10_351.pth', help='version of EfficentDet')
    parser.add_argument('--config', type=str, default='custom_datasets', help='save detection at')
